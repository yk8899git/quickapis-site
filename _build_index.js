...
/* ===== 轮播图 - AI硬件产品 ===== */
const SLIDES = [
  {tool:'unitree-go2', bg:'linear-gradient(135deg,#0c0c1d 0%,#1a1a3e 50%,#2d1b69 100%)', tag:'🤖 宇树Go2', title:'宇树四足机器人Go2：AI大模型+超感知，工业巡检到家庭陪伴', source:'宇树科技', time:'2026'},
  {tool:'roborock-saros-z70', bg:'linear-gradient(135deg,#1a2a1a 0%,#0d3b2e 50%,#064e3b 100%)', tag:'🧹 石头Saros Z70', title:'石头Saros Z70：仿生机械手扫地机器人，CES2025爆款', source:'石头科技', time:'2025'},
  {tool:'raybird-v3', bg:'linear-gradient(135deg,#1e1b4b 0%,#312e81 50%,#4338ca 100%)', tag:'👓 雷鸟V3', title:'雷鸟V3 AI眼镜：通义大模型加持，15小时续航，1600万拍摄', source:'雷鸟创新', time:'2026'},
  {tool:'xiaopeng-iron', bg:'linear-gradient(135deg,#1c1917 0%,#292524 50%,#44403c 100%)', tag:'🤖 小鹏Iron', title:'小鹏Iron人形机器人：62自由度+AI鹰眼视觉，2026年量产', source:'小鹏鹏行', time:'2026'},
  {tool:'ecovacs-x9', bg:'linear-gradient(135deg,#172554 0%,#1e3a5f 50%,#1e40af 100%)', tag:'🧹 科沃斯X9', title:'科沃斯X9：AIVI 3D避障+双滚刷，8800Pa旗舰扫地机器人', source:'科沃斯', time:'2026'},
  {tool:'qwen-glasses', bg:'linear-gradient(135deg,#7c2d12 0%,#9a3412 50%,#c2410c 100%)', tag:'👓 千问AI眼镜', title:'阿里巴巴千问AI眼镜：MWC2026发布，通义千问深度集成', source:'阿里巴巴', time:'2026'},
];
